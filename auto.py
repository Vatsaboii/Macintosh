...
def main():
    ...
    model_file = "/Users/srivatsa/digiboxx/res10_300x300_ssd_iter_140000.caffemodel"
    config_file = "/Users/srivatsa/digiboxx/deploy.prototxt.txt"
    input_image_path = "/Users/srivatsa/digiboxx/Cristiano_Ronaldo_playing_for_Al_Nassr_FC_against_Persepolis,_September_2023_(cropped).jpg"
    recognition_model_file = "/Users/srivatsa/digiboxx/dlib_face_recognition_resnet_model_v1.dat"
    shape_predictor_file = "/Users/srivatsa/digiboxx/shape_predictor_68_face_landmarks.dat"
    ...
    try:
        ...
        for name in recognized_names:
            if name is None:
                person_name = input("Please enter the name for the unknown face: ")
                folder_path = os.path.join(base_folder, person_name)
                os.makedirs(folder_path, exist_ok=True)
                file_name = f"{uuid.uuid4()}.jpg"
                image_path = os.path.join(folder_path, file_name)
                ...
                face_encoding = encode_faces(recognition_model, shape_predictor, image, faces)
                known_encodings.extend(face_encoding)
                known_names.extend([person_name] * len(face_encoding))
